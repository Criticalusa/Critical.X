...
import UIKit
    ...
    enum EKGDescription: String {
        ...
        \rAs in single lead EKGs, there are a few things that we should overall assess while looking at the
        tracing.
        ...
        \rP-wave: The P-wave should always be positive and leads II, III, and aVF.  If not, then it should not
        be considered a sinus rhythm.  When looking at the precordial leads (V1 – V6), at times the P waves can
        be biphasic in V1 (which is negatively deflected) no more than 1 mm.
        \rPR Interval: The PR interval should be between 0.12 – 0.20 seconds in all of the leads. Any increase
        in the duration of the PR interval could suggest a heart block.  You can read more about the details of
        the different blocks in the EKG section.
