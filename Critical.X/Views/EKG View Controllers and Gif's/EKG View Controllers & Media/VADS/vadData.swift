...
import Foundation
    ...
    enum VAD_Explanaton: String {
        ...
        Overview:
        The total artificial heart is a device used to bypass the cardiac system entirely indicated in patients with biventricular heart failure. It consists of two artificial pneumaticlly driven ventricles which are made from a biocompatible plastic. This prevents rejection from the body. The TAH is capable of producing a SV of 65 mL and CO of 12 L/min.
        \rWhat to know:
        ...
        case Impella = """
        \tOverview:
        \rThe Impella is a short-term micro-axial flow blood pump that is catheter based used for partial cardiac support. This micro device is placed under flouroscopy or echo guidance and advanced across the aortic valve.
