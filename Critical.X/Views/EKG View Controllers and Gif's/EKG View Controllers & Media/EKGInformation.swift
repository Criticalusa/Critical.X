...
enum RhythmDescription: String {
    ...
    case SVT = "Rate: ~ 160 - 280 bpm \n\nRhythm: Regular\n\nP-Wave: Often hidden\n\nP-R Interval: Variable\n\nQRS: Normal or Prolonged\n\nSupraventricular tachycardia is a tachydysrhythmia that is described to originate above the His Bundle.  SVT has a narrow QRS complex & regular rhythm unless an aberrancy is present.\n\nTypically, SVT is non-life threatening, however, when rates exceed 150 bpm, SVT can significantly reduce ventricular filling and pre-load. The reduced filling time results in a decreased cardiac output during systole. The result of the marked decreased cardiac output is hypotension."
    ...
    case Wenkebach = "Rate: 60 - 100\n\nRhythm: Regular\n\nP-Wave: 2:1 or 3:1\n\nP-R Interval: Variable\n\nQRS: Normal or Prolonged\n\nDuring a 2nd° type I AV block, some atrial impulses failed to reach the ventricles. You will recognize a progressive prolongation of the PR interval which subsequently culminates into a nonconductive P-wave. The R-R interval progressively shortens with each beat of the cardiac cycle.\n\nThe greatest increase in the PR interval is typically between the first and second beats of the cardiac cycle. 2nd° type I AV block is typically a benign rhythm that has a low probability of progressing into a 3rd° heart block."
