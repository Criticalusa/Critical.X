...
public var sectionsData: [Section] = [
    Section(name: "Blood Types", items: [
        ...
        Item(name: "Overview", detail: "Blood types are identified by antigens that are on the surface of the RBC's. The major trpes of antigens are grouped by the types seen below: A,B,AB,O- and Rn factor (+) or (-). Cross-matching is performed to determine the compatability."),
        ...
        Item(name: "ABO- AB", detail: "Has both the 'A' and 'B' antogen on the RBC. No antibodies in the plasma against the 'A' and 'B' antigens."),
    ...
    Section(name: "Crystalloids", items: [
        ...
        Item(name: "3% Saline (3% Hypetonic Saline)", detail: "Indications:\nTo increase the serum sodium and plasma volume. moderate inflammatory response in patients who are in shock.\n\nAdvantages:\nIt takes less fluid to resuscitate. Improves cardiac output and blood flow. It's as effective as mannitol in patients with increased intracranial pressure.\n\nDisadvantages:\nIf administered too fast, the patient could become hypokalemic and the Na could increase approximately 2-3 mmol/L. Seizures and disrhythmias could result.\n\nComposition:\nOsmolarity: 1026 mOsm/L; Na 512 mEq/L; Chloride 513 mEq/L."),
         
        Item(name: "Ringers Lactate", detail: "Indications:\nFluid volume replacement for hemorrhagic shock. Contains the same components as the interstitial fluid- which tends to shift to the vasculature during hemorrhage.\n\nAdvantages:\nPotassium and calcium promote myocardial contractility, calcium age with clotting no increase in serum sodium chloride noted. The fluid is isotonic. Electrolytes are balanced and lactate is converted to glucose in carbonic acid.\n\nDisadvantages:\n Dilutes the plasma proteins in red blood cells.\n\nComposition:\nSodium  130 mEq/L, Chloride: 109 mEq/L, Potassium: 4 mEq/L, Calcium: 3 mEq/L, Lactate: 27 mEq/L, pH: 6.5, Osmolarity: 275 mOsm/liter."),
    ...
    Section(name: "Blood Products", items: [
        ...
        Item(name: "Fresh Frozen Plasma", detail: "Overview:\nAfter blood donation, the liquid portion of the blood is extracted and freezed. This is what we call fresh frozen plasma (FFP). FFP is preserved for patients who have bleeding disorders.\n\nIndications:\nFFP is used to replace clotting factors only. It's not used for volume expansion. FFP is getting after single or multiple units of packed red blood cells to prevent coagulopathy - Bleeding diseases of unknown causes – Coumadin overdose with severe bleeding.\n\nDosage:\n1 – 2 units for every 1 to 2 units of packed red blood cells.\n\nVolume with blood fileter:\n150-200 mL\n\nComposition:\nPlasma contains no red blood cells, cross matching is not required. Use within 24 hours after the plasma is thawed."),
        ...
        Item(name: "Platelets", detail: "Overview:\nPlatelets (thrombocytes) play a vital role in hemostasis (which is the formation of blood clots). It usually indicated for patients with a low platelet count also known as thrombocytopenia.\n\nIndications:\nPlatelets are used to control or prevent bleeding. Platelets are used prophylactically for platelet counts less than 10,000 to 20,000. Do not transfuse platelets to patients with immune thrombocytopenic purpura unless it's life-threatening – or use with massive blood transfusions.\n\nDosage:\nAdults – six – 10 units. Pediatrics: 5 mg/kg.\n\nVolume with blood fileter:\n50 mL/Unit.\n\nComposition:\nOne unit represents that the platelets were removed from one unit of blood."),
