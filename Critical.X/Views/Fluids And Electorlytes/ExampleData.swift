...
public var sectionsData: [Section] = [
    Section(name: "Blood Types", items: [
        ...
        Item(name: "Overview", detail: "Blood types are identified by antigens that are on the surface of the RBC's. The major types of antigens are grouped by the types seen below: A, B, AB, O- and Rn factor (+) or (-). Cross-matching is performed to determine the compatibility."),
