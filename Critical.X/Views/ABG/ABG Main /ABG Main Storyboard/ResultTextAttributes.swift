...
extension ResultViewController {
    ...
    func mixedDisturbance2_CriticalPearls()  {
        ...
        //1 Change color
        attributedText.apply(color: #colorLiteral(red: 0.1215686275, green: 0.1294117647, blue: 0.1411764706, alpha: 1), subString: "With metabolic issuess, look to correct the underlying issue.")
        // Change font
        attributedText.apply(font: customFont!, subString: "With metabolic issuess, look to correct the underlying issue.")
        
        //2 Change color
        attributedText.apply(color: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), subString: "Chloride Response:")
        // Change font
        attributedText.apply(font: customFont!, subString: "Chloride Response:")
        
        
        //3 Change color
        attributedText.apply(color: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), subString: "chloride- unresponsive")
        // Change font
        attributedText.apply(font: customFont!, subString: "chloride- unresponsive")
        
        //4 Change color
        attributedText.apply(color: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), subString: "chloride-responsive")
        // Change font
        attributedText.apply(font: customFont!, subString: "chloride-responsive")
        
        //5 Change color
        attributedText.apply(color: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), subString: "Note:")
        // Change font
        attributedText.apply(font: customFont!, subString: "Note:")
        
        //6 Change color
        attributedText.apply(color: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), subString: "Acetazolamide (Diamox)")
        // Change font
        attributedText.apply(font: customFont!, subString: "Acetazolamide (Diamox)")
        
        //7 Change color
        attributedText.apply(color: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), subString: "Labs:")
        // Change font
        attributedText.apply(font: customFont!, subString: "Labs:")
        
        
        //8 Change color
        attributedText.apply(color: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), subString: "Respiratory alkalosis boils down to one pathway - Minute Ventilation - RR x TV")
        // Change font
...
extension ResultViewController  {
    ...
    func criticalAttributes_CompensatedMetabolic_Alkalosis()  {
        ...
        if changedText.contains(loop) {
            ...
            //4 Change color
            attributedText.apply(color: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), subString: loop)
            // Change font
        ...
        if changedText.contains(gastric) {
            ...
            //4 Change color
            attributedText.apply(color: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), subString: gastric)
            // Change font
        ...
        if changedText.contains(administering) {
            ...
            //4 Change color
            attributedText.apply(color: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), subString: administering)
            // Change font
       ...
       //D
        if changedText.contains(laxitaves) {
            ...
            //4 Change color
            attributedText.apply(color: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), subString: laxitaves)
            // Change font
        ...
        if changedText.contains(hypercapnea) {
            ...
            //4 Change color
            attributedText.apply(color: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), subString: hypercapnea)
            // Change font
        ...
        if changedText.contains(contractionalAlk) {
            ...
            //4 Change color
            attributedText.apply(color: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), subString: contractionalAlk)
            // Change font
...
extension ResultViewController {
    ...
    func changeRespAcidosisTextAttributes_CriticalPearls()  {
        ...
        //1 Change color
        attributedText.apply(color: #colorLiteral(red: 0.1215686275, green: 0.1294117647, blue: 0.1411764706, alpha: 1), subString: "Respiratory acidosis boils down to one pathway - Minute Ventilation - RR x TV")
        // Change font
...
extension ResultViewController {
    ...
    func changeMetabolicAcidosisTextAttributes_CriticalPearls() {
        ...
        //1 Change color
        attributedText.apply(color: #colorLiteral(red: 0.1215686275, green: 0.1294117647, blue: 0.1411764706, alpha: 1), subString: "Clinical changes:")
        // Change font
        attributedText.apply(font: customFont!, subString: "Clinical changes:")
        
        
        //2 Change color
        attributedText.apply(color: #colorLiteral(red: 0.1215686275, green: 0.1294117647, blue: 0.1411764706, alpha: 1), subString: "A side effect of NaHC03 treatment is the subsequent rise in PaC02.")
        // Change font
        attributedText.apply(font: customFont!, subString: "A side effect of NaHC03 treatment is the subsequent rise in PaC02.")
        
        //2 Change color
        attributedText.apply(color: #colorLiteral(red: 0.1215686275, green: 0.1294117647, blue: 0.1411764706, alpha: 1), subString: "More than one primary acid-base disorder may be present simultaneously. ")
        // Change font
        attributedText.apply(font: customFont!, subString: "More than one primary acid-base disorder may be present simultaneously.")
        
        //3 Change color
        attributedText.apply(color: #colorLiteral(red: 0.1215686275, green: 0.1294117647, blue: 0.1411764706, alpha: 1), subString: "Although there's low-quality evidence from observational studies, current literature suggests that NaHC03 is held unless the pH is < 7.1, then address the primary process once the pH rises.")
        // Change font
        ...
        //4 Change color
        attributedText.apply(color: #colorLiteral(red: 0.1215686275, green: 0.1294117647, blue: 0.1411764706, alpha: 1), subString: "Advantages of NaHC03:")
        // Change font
        attributedText.apply(font: customFont!, subString: "Advantages of NaHC03:")
        
        //5 Change color
        attributedText.apply(color: #colorLiteral(red: 0.1215686275, green: 0.1294117647, blue: 0.1411764706, alpha: 1), subString: "Disadvantages include:")
        // Change font
...
extension ResultViewController {
    ...
    func change_Resp_Alkalosis_TextAttributes_CriticalPearls() {
        ...
        //1 Change color
        attributedText.apply(color: #colorLiteral(red: 0.1215686275, green: 0.1294117647, blue: 0.1411764706, alpha: 1), subString: "Respiratory alkalosis boils down to one pathway - Minute Ventilation - RR x TV")
        // Change font
        attributedText.apply(font: customFont!, subString: "Respiratory alkalosis boils down to one pathway - Minute Ventilation - RR x TV")
        
        
        //2 Change color
        attributedText.apply(color: #colorLiteral(red: 0.1215686275, green: 0.1294117647, blue: 0.1411764706, alpha: 1), subString: "decrease in C02 with or without a mandatory decrease in HC03.")
        // Change font
        attributedText.apply(font: customFont!, subString: "decrease in C02 with or without a mandatory decrease in HC03.")
        
        //3 Change color
        attributedText.apply(color: #colorLiteral(red: 0.1215686275, green: 0.1294117647, blue: 0.1411764706, alpha: 1), subString: "Chloride Response:")
        // Change font
        attributedText.apply(font: customFont!, subString: "Chloride Response:")
        
        
        //4 Change color
        attributedText.apply(color: #colorLiteral(red: 0.1215686275, green: 0.1294117647, blue: 0.1411764706, alpha: 1), subString: "Note:")
        // Change font
        attributedText.apply(font: customFont!, subString: "Note:")
        
        
        //5 Change color
        attributedText.apply(color: #colorLiteral(red: 0.1215686275, green: 0.1294117647, blue: 0.1411764706, alpha: 1), subString: "Increases in respiratory minute volume or respiratory rate will cause the pH to increase.")
        // Change font
        ...
        //6 Change color
        attributedText.apply(color: #colorLiteral(red: 0.1215686275, green: 0.1294117647, blue: 0.1411764706, alpha: 1), subString: "Acetazolamide (Diamox)")
        // Change font
        attributedText.apply(font: customFont!, subString: "Acetazolamide (Diamox)")
...
extension ResultViewController {
    ...
    func mixedDisturbance1_Explain() {
        ...
        //1
        attributedText.apply(color: #colorLiteral(red: 0.1215686275, green: 0.1294117647, blue: 0.1411764706, alpha: 1), subString: "In Respiratory Acidosis:")
...
extension ResultViewController {
    func mixedDisturbance1_CriticalPearls()  {
        ...
        if mixedAcidosis.contains(bicarbNotInvolved) {
            ...
            //4 Change color
            attributedText.apply(color: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), subString: bicarbNotInvolved)
            // Change font
        ...
        if mixedAcidosis.contains(disadvantages) {
            ...
            //4 Change color
            attributedText.apply(color: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), subString: disadvantages)
            // Change font
        ...
        if mixedAcidosis.contains(advantagesOfHC03) {
            ...
            //4 Change color
            attributedText.apply(color: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), subString: advantagesOfHC03)
            // Change font
        ...
        if mixedAcidosis.contains(althoughLowQuality) {
            ...
            //4 Change color
            attributedText.apply(color: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), subString: althoughLowQuality)
            // Change font
        ...
        if mixedAcidosis.contains(moreTHanOne) {
            ...
            //4 Change color
            attributedText.apply(color: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), subString: moreTHanOne)
            // Change font
        ...
        if mixedAcidosis.contains(sideEffect) {
            ...
            //4 Change color
            attributedText.apply(color: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), subString: sideEffect)
            // Change font
        ...
        if mixedAcidosis.contains(clinicalChanges) {
            ...
            //4 Change color
            attributedText.apply(color: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), subString: clinicalChanges)
            // Change font
        ...
        if mixedAcidosis.contains(MoreThan) {
            ...
            //4 Change color
            attributedText.apply(color: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), subString: MoreThan)
            // Change font
            attributedText.apply(font: customFont!, subString: MoreThan)
        ...
        if mixedAcidosis.contains(MV) {
            ...
            //4 Change color
            attributedText.apply(color: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), subString: MV)
            // Change font
...
extension ResultViewController {
    ...
    func mixedDisturbance4_CriticalPearls() {
       ...
       // Start of metabolic alkalosis
        ...
        //6 Change color
        attributedText.apply(color: #colorLiteral(red: 0.1215686275, green: 0.1294117647, blue: 0.1411764706, alpha: 1), subString: "Contraction Alkalosis:")
        // Change font
        attributedText.apply(font: customFont!, subString: "Contraction Alkalosis:")
        
        //7 Change color
        attributedText.apply(color: #colorLiteral(red: 0.1215686275, green: 0.1294117647, blue: 0.1411764706, alpha: 1), subString: "This generally can be corrected by administering NaCl fluids, intravenously.")
        // Change font
        ...
        //8 Change color
        attributedText.apply(color: #colorLiteral(red: 0.1215686275, green: 0.1294117647, blue: 0.1411764706, alpha: 1), subString: "chloride- unresponsive or resistant")
        // Change font
        attributedText.apply(font: customFont!, subString: "chloride- unresponsive or resistant")
        //9 Change color
        attributedText.apply(color: #colorLiteral(red: 0.1215686275, green: 0.1294117647, blue: 0.1411764706, alpha: 1), subString: "chloride-responsive")
        // Change font
        attributedText.apply(font: customFont!, subString: "chloride-responsive")
        
        //8 Change color
        attributedText.apply(color: #colorLiteral(red: 0.1215686275, green: 0.1294117647, blue: 0.1411764706, alpha: 1), subString: "Loop or Thiazide diuretics:")
        // Change font
