...
class ResultViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        loadingdots.setAnimation(named: "material_wave_loading")
        // Executes the play
        loadingdots.play()
        // Here we loop the animation and it keeps playing
        loadingdots.loopAnimation = true
    ...
    enum Result {
        ...
        func clinicalPearls() -> String {
            ...
            case .metabolic_ACIDOSIS, .Normal:
                ...
                \r• Advantages of NaHC03: When treating a chronic metabolic acidosis, there can be a progression of renal disease, negative nitrogen balance, and growth retardation.
