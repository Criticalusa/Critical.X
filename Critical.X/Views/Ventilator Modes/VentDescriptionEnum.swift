...
enum VentilatorModes: String {
    ...
    \rBottom Line:🎖 When the ventilator is set at a rate of 14, the ventilator will deliver 14 guaranteed breaths (controlled breaths) per minute - even if the patient does not make any effort. When the ventilator senses and effort from the patient, it will deliver additional breaths (assisted breaths) above and over the set rate. These additional breaths will be the full volume or pressure, and inspiratory time selected by the clinician..
    """
    ...
    \r1. P-High: This is the pressure used to recruit the alveoli. It's the CPAP. The higher the P-High, , the higher the peak pressure, and thus mean airway pressure (oxygenation). This is typically set 3-5 cmH2O above the men airway pressure on the conventional mode.
