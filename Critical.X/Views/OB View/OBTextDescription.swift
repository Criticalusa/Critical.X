...
extension OBCollectionView {
    ...
    enum fetalDescriptionsText: String {
        ...
        \rAlthough these decelerations are not associated with fetal distress and are reassuring, maybe carefully differentiated from other non-reassuring decelerations such as hypoxia and acidemia.
        """
        
        
        
        case late = """
        \rLate decelerations also termed as \"uteroplacental insufficiency\" is when the fetal heart rate returns to baseline after the contraction has ended.This represents uterine or placental function. The descent and return are both gradual and smooth. Like early decelerations, this deceleration reaches its nadir within 30 seconds of its onset.
        ...
        \rA pattern of persistent late decelerations is not reassuring, and further evaluation of the fetal pH's indicated. Persistent late decelerations are associated with decreased beat-to-beat variability which is also another ominous sign."
        """
        ...
        \rDepending on the onset,  the deceleration varies typically with the contraction.  The shape of the deceleration can vary widely and may appear as a V, U, or W shape.  They may be either periodic or episodic. Often, there are small celebrations immediately before and immediately following the deceleration  (as you could see above).
        \rThese decelerations are referred to as \"shoulders\". The most frequent reason for variable decelerations is from umbilical cord compression. Initial or mild core compression will result in occlusion of the umbilical vein, which is larger than the arteries and less rigid, which results in decreased venous return and tachycardia – which augments cardiac output.  This is precisely why you will notice an initial increase in heart rate (shoulder) which proceeds of deceleration.
        ...
        \rAs the court becomes decompressed, the series of events is reversed.  An acceleration may follow the deceleration before returning to baseline.
        """
    }
