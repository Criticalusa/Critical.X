...
class CentralLine_ViewController: UIViewController {
    ...
    func loadInfo() {
        ...
        centralLineInfo =
        """
        \rCentral venous catheterization is necessary to monitor hemodynamics, administer medications and fluids in critically ill patients. It can also but used as a conduit for Pulmonary Artery catheters, transvenous pacemakers, defibrillators, CRRT, plasmapheresis and hemodialysis catheters and venous stenting.
        ...
        // Description about the first images.
        ...
        \rCannulation of the right jugular vein is generally preferred as to cannulation of the left because it provides more direct access to the right atrium– Avoids the thoracic duct– Reduces procedure time –And is associated with fewer complications.
        \r Preparation:
        \r • Check consent • Check vitals • Check for anti-coagulants and INR • Make sure that the QRS complex volume in up to ensure that any arrhythmias are identified while performing the procedue. • Check and prepare materials in the central line kit • Check equipment and ultrasound • Prep & drape the patient • TIMEOUT
        ...
        \rThe jugular vein is typically found about 2 to 3 cm above the clavicle, However, it’s better to go a little bit higher in a triangle because you want to reduce any possibility of a pneumothorax.
        ...
        """
        confirmation = """
        \rThe ultrasounds below demonstrate the point of venous cannulation. You can appreciate \"venous wall tenting\" (sagittal view on the right), and entrance of the needle into the vein via a long axis view.
        """
        
        catheterPlacement = """
        CXR Confirmation:
        \rThe catheter is orientated vertically as seein the the CXR below.
