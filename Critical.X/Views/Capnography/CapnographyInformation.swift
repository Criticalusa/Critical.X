   ...
   //Function to show the detail Information
    func waveFormSubtitleData() -> String {
        ...
        case .Apnea:
            ...
            return "Complete loss of end-tidal CO2 waveform.\n\nD.O.P.E - Use this pneumonic to troubleshoot an acute loss of the waveform. Disconnections, Obstructions, Pulmonary embolism, Equipment failures. Also, consider apnea tests in brain dead patients."
        ...
        case .Hyperventilation:
            ...
            return "Respiratory rate gets faster. Notice a slight decrease in C02.\n\nFast breathing (tachypnea) doesnt necessarily increase todal volume. Anxiety, head injuries, diabetic emergencies, pulmonary embolism, acute myocardial infarction, etc. will."
