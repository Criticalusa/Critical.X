...
class ViewController: UIViewController, UICollisionBehaviorDelegate {
    ...
    var dataDetail = [
        ...
        //APRV
        "Airway Pressure Release Ventilation (APRV) is similar to PCIRV. Instead of being a variation of PCV in which the I: E ratio is reversed. APRV is a variation of CPAP that releases pressure temporarily on exhalation. \n\nThis unique mode of ventilation results in higher than average airway pressures. Patients can spontaneously ventilate at both low and high pressures – although typically most (or all) ventilation occurs at the high pressure. In the absence of attempted breaths, APRV and PCIRV are identical.\n\n As in PCIRV, hemodynamic compromise is always a concern in APRV. Additionally, APRV typically requires increased sedation.",
        ...
        //CMV
        "Control mode ventilation (CMV) is a time – cycling process. The timing mechanism generates the inspiratory title volume breath independent of the patient's respiratory effort. During CMV, the ventilator does not allow the patient to self-generate a title volume breath.\n\nPatients awaking from sedation or pharmacologic paralysis may experience agitation and air hunger since they cannot interface with the ventilator.\n\nControl Mode ventilation is used primarily with patients unable or not required to generate a voluntary respiratory effort.\n\nControl modes in AC modes are technical variations of each other – differentiated only by the preset triggering threshold for AC ventilation. Clinicians traditionally choose A/C mode as the initial mode due to the simplicity, comfort level and patient ability to trigger a breath.",
        
        //CPAP/PS
        "Continuous Positive Airway Pressure, CPAP allows for constant pressure maintained above atmospheric pressure throughout the respiratory cycle. The patient must be able to generate their own breath to use this mode.\n\nTo provide this mode, the ventilator respiratory rate is adjusted to zero, so that no control breaths are delivered during the cycle.\n\nA CPAP of 5 cm of water is traditionally started to maintain pressure above atmospheric pressure. CPAP can be provided alone or in combination with pressure support ventilation. During spontaneous ventilation, the patient receives a constant CPAP above atmospheric pressure augmented with a preset pressure support ventilation during each spontaneous breath.\n\nExample, CPAP 5 cm of water plus pressure support ventilation 10 cm of water. CPAP by itself or in combination with pressor support is the primary mode used to promote spontaneous ventilations to assist with discontinuation of mechanical ventilation.",
        //IRV
        "Inverse Ratio Ventilation is a subset of pressure control ventilation in which the inflation time is prolonged. In IRV, 1:1, 2:1, or 3:1 may be used. Normal I: E ratio is 1:3. This lowers P carry pressures, but increases mean airway pressures. The result may improve oxygenation but at the expense of compromise venous return and cardiac output, thus is not clear that this mode of ventilation leads to improved survival. IRV's primary indication is in patients with ARDS with refractory hypoxemia or hypercapnia.",
        //PCV
